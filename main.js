 ...
 * @returns {Promise<{success: boolean, id?: number, error?: string}>} - Success status, new row ID (if inserted), or an error message.
 */
 ...
 * @returns {Promise<{success: boolean, error?: string}>} - Success status or an error message.
 */
 ...
 * @returns {Promise<{success: boolean, archived?: number, error?: string}>} - Success status, archived status, or an error message.
 */
 ...
 * @returns {Promise<{success: boolean, openProjects?: number, completedProjects?: number, error?: string}>}
